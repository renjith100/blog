...
summary: 'Well, I learned more lessons learned than I expected'
---
...
## Why I Built It
I wanted a scroll progress bar in a Next.js project. The existing packages either had too many dependencies, weren't TypeScript-friendly, or didn't work with the App Router. So I built my own and decided to publish it.
...
When I first published, I naively thought I'd compile my TypeScript to JavaScript and ship that. Then I started seeing the.
